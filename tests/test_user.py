...
class TestUser(unittest.TestCase):
    def setUp(self):
        ...
        self.username = game_char['username']
...
class TestGamePlay(TestUser):
    ...
    def test_move_forward_then_turn(self):
        """Test to ensure the character move forward 4 times before turning """
...
class TestPasswordHash(TestUser):
    def test_password_hash(self):
        ...
        self.assertEqual(self.user.hash_password(self.password), self.user.hashed_password)

    def test_validate_hashed_password(self):
